...
+'          <li role="presentation" ><a href="#org">人员</a></li>'
...
+'      </tr>'
+'      <tr>'
+'        <td><input id="' + conf.modalId + '_item_alias_1" type="radio" name="selectedItem" class="selectedItem" value="常用语:公司管理者" title="常用语:公司管理者" style="margin-top:0px;"></td>'
+'        <td>常用语:公司管理者</td>'
+'      </tr>'
+'    </tbody>'
+'  </table>'
