var createUserPickerForPersonInfo = function (conf) {
    var ids = "";
    var count = 0;
    conf = conf ? conf : {};
    var defaults = {
    ...
    if ($('#' + conf.modalId).length == 0) {
        $(document.body).append(
            '<div id="' + conf.modalId + '" class="modal fade" style="z-index:1000000">'
    ...
    $(document).delegate('.userPickerForPersonInfo .input-group-addon', 'click', function (e) {
        ...
        $('#' + conf.modalId).data('userPickerForPersonInfo', $(this).parent());
        $('#' + conf.modalId).modal();
    ...
    $(document).delegate('#' + conf.modalId + '_select', 'click', function (e) {
        ...
        var userPickerElement = $('#' + conf.modalId).data('userPickerForPersonInfo');
        if (conf.multiple) {
