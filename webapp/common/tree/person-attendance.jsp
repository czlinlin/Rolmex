  ...
  <ul id="treePersonMenuAttendance" class="ztree"></ul>
<!-- end of sidebar -->

<script type="text/javascript">
    var rootNode="${searchRootNode==null?'':searchRootNode}";
    
    var settingAttendance = {
        data: {
            simpleData: {
                enable: true
            },
        ...
        callback: {
            onClick: function (event, treeId, treeNode) {
                ...
                window.frames[0].location = '${tenantPrefix}/party/attendance-list-i.do?partyStructTypeId=1&partyEntityId=' + treeNode.id;
            },
    ...
    var dialogAsyncLoading;
    function beforeClick(treeId, treeNode) {
    	if(treeNode.id == 1){
    		return false;
    	}
    	dialogAsyncLoading= bootbox.dialog({
    	    message: '<p class="text-center">数据加载中...</p>',
    	    closeButton: false
    	});
    }
    ...
    $(function () {
        $.fn.zTree.init($("#treePersonMenuAttendance"), settingAttendance, zNodes);
        //alert("${partyId}");
