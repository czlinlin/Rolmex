  ...
  <div class="form-group"> 
   ...
   <!-- <div class="form-group">
	   <label class="control-label col-md-2" for="orgInputUser_priority">岗位编号</label>
		<div class="col-sm-5">
	  	<input id="orgPositionNo" type="text" name="positionNo" value="" size="40" class="form-control required number" maxlength="8" autocomplete="off">
	   </div>
   </div>
   <div class="form-group"> 
 	 ...
 	 <div id="div_realPosition" class="form-group" style="display:none;">
			...
			<div class="col-sm-5 userPickerForPersonInfo">
				<div class="input-group">
					<input id="_task_name_key" type="hidden" name="postId" value="">
					<input type="text" class="form-control required" id="postName" name="postName" value="" readonly="readonly">
...
<c:if test="${partyType.type == 0}">
  ...
  <div class="form-group">
	...
	<div class="col-sm-5">
      <input id="shortName" type="text" name="shortName" value="" placeholder="请输入四位大写英文字母" size="40" class="form-control required" minlength="4" maxlength="4" autocomplete="off">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-md-1" for="orgInputUser_priority">排序</label>
