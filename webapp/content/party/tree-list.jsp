<%@page import="com.mossle.user.PersonInfoConstants"%>
...
<%pageContext.setAttribute("currentChildMenu", "组织机构图");%>
		...
		try {
			...
			for (PartyStruct partyStruct : partyEntity.getChildStructs()) {
				if (partyStruct.getPartyStructType().getId() == partyStructTypeId) {
					if (partyStruct.getChildEntity().getDelFlag().equals(PersonInfoConstants.DELETE_FLAG_NO)) {
      ...
      <div class="panel panel-default">
		...
		<div class="panel-body">
		  <form name="orgForm" method="post" action="tree-list.do" class="form-inline">
			...
			<button class="btn btn-default a-submit" > 查看</button>
		  </form>
		  </div>
		  </div>
