      ...
      <div style="margin-bottom: 20px;">
	    <div class="pull-left">
	      <div class="btn-group" role="group">
		    ...
		    <button class="btn btn-default a-insert" onclick="location.href='org-admin-input.do?partyStructTypeId=2&partyEntityId=${partyEntityId}&partyTypeId=1'">关联人员</button>
		  </div>
		  <button class="btn btn-default a-insert" onclick="location.href='org-list-i.do?partyStructTypeId=${partyStructTypeId}&partyEntityId=${partyEntityId}&partyTypeId=${item.id}'">返回</button>
