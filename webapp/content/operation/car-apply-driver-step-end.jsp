	...
	<script type="text/javascript">
		...
		function CompleteTask(flag) {
			...
			if(flag==6){
				...
				//借车里程 为空  不允许提交
    			if ( document.getElementById('borrowCarMileage').value ==""){
    				alert("请输入借车里程！");
    				return false;
    			}
            	
    			//还车里程 为空  不允许提交
    			if ( document.getElementById('returnCarMileage').value ==""){
    				alert("请输入还车里程！");
    				return false;
    			}
    			...
    			//加油金额 为空  不允许提交
    			if ( document.getElementById('oilMoney').value ==""){
    				alert("请输入加油金额！");
    				return false;
    			}
    			
    			//剩余油量 为空  不允许提交
    			if ( document.getElementById('remainOil').value ==""){
    				alert("请输入剩余油量！");
    				return false;
    			}
			}
     ...
     <section id="m-main" class="col-md-12" style="padding-top:65px;">
          ...
          <tr>
           ...
           <tr>
        	...
        	<tr>
				...
				<td colspan="2" class="f_r_td">
					<span id="borrowCarTime" name="borrowCarTime"></span>
					&emsp;;至&emsp;
	            	<span id="returnCarTime" name="returnCarTime"></span>
	            </td>
				<td colspan="1" class="f_r_td">
					共<span id="totalTime" name="totalTime" style="padding:0 6px;"></span>时
				</td>
	       </tr>
	      <tr>    
               <td class="f_td">
                   <span style="color:Red">*</span>借车里程</span>：
               </td>
               <td>
               	<input oninput="getNumber(this)" onkeypress="getNumber(this)" onkeyup="getNumber(this)" onblur="getNumber(this)" name="borrowCarMileage" id="borrowCarMileage" maxlength="20" style="background:#eee;"> 
               </td>
              <td class="f_td">
                   <span style="color:Red">*</span>还车里程</span>：
               </td>
               <td>
                   <input oninput="getNumber(this)" onkeypress="getNumber(this)" onkeyup="getNumber(this)" onblur="getNumber(this)" name="returnCarMileage" id="returnCarMileage" maxlength="20"  style="background:#eee;"> 
               </td>
           </tr>
            <tr> 
                <td class="f_td">
                    <span style="color:Red">*</span>行驶里程</span>：
                </td>
                <td colspan="3">
                    <input oninput="getNumber(this)" onkeypress="getNumber(this)" onkeyup="getNumber(this)" onblur="getNumber(this)" name="mileage" id="mileage" maxlength="20" style="width:100%;background:#eee;"> 
                </td>
          </tr>
          <tr>    
                <td class="f_td">
                    <span style="color:Red">*</span>加油金额</span>：
                </td>
                <td>
                	<input oninput="getNumber(this)" onkeypress="getNumber(this)" onkeyup="getNumber(this)" onblur="getNumber(this)" name="oilMoney" id="oilMoney" maxlength="10" style="background:#eee;"> 
                </td>
               <td class="f_td">
                    <span style="color:Red">*</span>剩余油量</span>：
                </td>
                <td>
                    <input oninput="getNumber(this)" onkeypress="getNumber(this)" onkeyup="getNumber(this)" onblur="getNumber(this)" name="remainOil" id="remainOil" maxlength="20" style="background:#eee;"> 
                </td>
          </tr>
      		<tr>
		...
		<div class="navbar navbar-default navbar-fixed-bottom">
			<div class="text-center" style="padding-top:8px;">
				<button id="completeTask1" type="button" class="btn btn-default" onclick="CompleteTask(6)">提交</button>
...
function getNumber(ele){
	if(!ele.value.match(/^\d*?\.?\d*?$/))
		ele.value=ele.t_value;
	else
		ele.t_value=ele.value;
	
	if(ele.value.match(/^(\d+(?:\.\d+)?)?$/))
		ele.o_value=ele.value
}
</script>
