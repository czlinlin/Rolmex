            ...
            if (id != "") {
                $.getJSON('${tenantPrefix}/rs/processBusiness/getBusinessInfo', {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        //alert(JSON.stringify((data[i].businessDetail)));
                      ...
                      //20180328 cz 业务细分是'启明' 的申请，标题改成 "业务审批单（属地项目部）"
                        if(data[i].businessDetail=="启明活动"){
                        	var h1= document.getElementsByTagName("h1")[0];
        			  	 	h1.innerHTML = "业务审批单（属地项目部）";
                        }
	         ...
	         $.ajax({      
		            url: '${tenantPrefix}/rs/bpm/getApplyActivity',      
		            datatype: "json",
            ...
            <div id="xf-form-table">
                <div id="xf-1" class="xf-section">
                	<c:if test="${isArea == true }">
						...
						<c:if test="${empty title }">
							<h1 id="hId" style="text-align:center;">业务审批单（分公司）</h1>
						</c:if>
                	</c:if>
                	<c:if test="${isArea != true }">
                		<h1 id="hId" style="text-align:center;">业务审批单（分公司）</h1>
                            ...
                            <td id="xf-2-0-0" class="xf-cell xf-cell-right xf-cell-bottom xf-cell-top xf-cell-left"
                                ...
                                <div class="xf-handler">
                                    <label style="display:block;text-align:right;margin-bottom:0px;">
                                    	提交次数： <input style="border:0px;width:10px" readonly type="text" id="submitTimes"
                                            name="submitTimes"> &nbsp;&nbsp;申请单号:<input type="text" id="applyCode" name="applyCode" style="border:0px" readonly>
                                     </label>                                                  
                                </div>
                            </td>
                        </tr>
                        ...
                        <c:if test="${isArea != true }">
	                        <tr id="xf-2-5">
	                            ...
	                            <td id="xf-2-5-3" class="xf-cell xf-cell-right xf-cell-bottom xf-cell-top xf-cell-left">
	                                <div class="xf-handler" id="branchOffice">
	                                </div>
	                            </td>
	                        </tr>
                        </c:if>
