      ...
      <section id="m-main" class="col-md-12" style="padding-top:65px;">
		...
		<div id="xf-form-table">
			<div id="xf-1" class="xf-section">
				<h1 style="text-align:center;">业务抄送单（集团）</h1>
			</div>
					...
					<tbody>
						<tr id="xf-2-0">
							<td id="xf-2-0-0" class="xf-cell xf-cell-right xf-cell-bottom xf-cell-top xf-cell-left" colspan="4">
								<div class="xf-handler">
									<label style="display:block;text-align:right;margin-bottom:0px;">提交次数： <input style="border:0px;width:10px" readonly type="text" id="submitTimes" name="submitTimes">      &nbsp;&nbsp;申请单号:<input type="text" id="applyCode" name="applyCode" value="<%=request.getParameter("code") %>" style="border:0px" readonly></label>
								</div>
							</td>
						</tr>
						<tr id="xf-2-1">
							...
							<td id="xf-2-1-1" class="xf-cell xf-cell-right xf-cell-bottom" colspan="3">
								<div class="xf-handler">
									<input id="theme" maxlength="100" name="theme" type="text" style="width:100%" readonly>
								</div>
							</td>
						</tr>
						<tr id="xf-2-2">
							...
							<td id="xf-2-2-1" class="xf-cell xf-cell-right xf-cell-bottom" colspan="3">
								<div class="xf-handler">
									<input id="cc" name="cc" type="text" style="width:100%" readonly>
								</div>
							</td>
						</tr>
						<tr id="xf-2-3">
						...
						<tr id="xf-2-6">
							...
							<td id="xf-2-6-1" class="xf-cell xf-cell-right xf-cell-bottom xf-cell-top xf-cell-left" colspan="3">
								<div class="xf-handler">
									<textarea id="applyContent" name="applyContent" rows="10" cols="1" style="width:100%" maxlength="4000" onkeyup="MaxWords()" readonly></textarea>
								</div>
							</td>
						</tr>
						<tr id="xf-2-7">
