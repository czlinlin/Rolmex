...
<html lang="en">
  ...
  <head>
    ...
    <script type="text/javascript" src="${cdnPrefix}/userpicker3-v2/userpickerbypart.js"></script>
...
<form id="pimRemindForm" method="post" action="msg-info-save.do" class="form-horizontal">
  ...
  <div class="form-group">
    <label class="control-label col-md-1" for="userBase_username"><spring:message code="user.user.input.username" text="收件人"/></label>
	<div class="col-sm-5">
	  <div class="input-group userPicker">
        <input id="msgInfo_username" type="hidden" name="username" value="${model.code}">
        <input type="text" class="form-control required" id="party_username" name="party_username" placeholder="" value="${model.username}" minlength="2" maxlength="50" readonly="readonly">
  ...
  <div class="form-group">
	...
	<div class="col-sm-5">
	  <input id="msg-info_name" type="text" name="name" value="${model.name}" class="form-control required" minlength="2" maxlength="50" >
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-md-1" for="pimRemind_description">内容</label>
	<div class="col-sm-5">
	  <textarea id="msg-info_descn" name="content" style="width: 490px;" rows="10" class="form-control">${model.content}</textarea>
    </div>
  </div>
  <div class="form-group">
