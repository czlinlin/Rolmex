...
<head>
    ...
    <script type="text/javascript">
        var config = {
            ...
            cmsPublishUrl: "${tenantPrefix}/rs/cms/cms-article-publish",
            cmsDelUrl: "${tenantPrefix}/rs/cms/cms-article-del"
        };
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form name="cms-articleForm" method="post"
                      action="cms-article-temp.do" class="form-inline">
            ...
            <div class="panel panel-default">
                ...
                <table id="cmsArticleGrid" class="table table-hover">
                    ...
                    <c:forEach items="${page.result}" var="item">
                        <tr>
                            <td>
                                &nbsp;&nbsp;<a href="javascript:" onclick="fnCmsDel(${item.id})"> 删除</a>
                                &nbsp;&nbsp;<a href="cms-article-modify.do?id=${item.id}">修改</a>
                                &nbsp;&nbsp;<a href="javascript:" onclick="fnCmsPublish(${item.id})">发布 </a>
                            </td>
