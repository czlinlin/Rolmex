                        ...
                        <div class="col-sm-9">
                            <div id="pickerStartTime" class="input-group date">
                                <input type="text" name="startTime"
                                       value="<fmt:formatDate value='${model.startTime}' type="both" pattern='yyyy-MM-dd HH:mm:ss '/>"
                        ...
                        <div class="col-sm-9">
                            <div id="pickerEndTime" class="input-group date">
                                <input id="endTime" type="text" name="endTime"
                                       value="<fmt:formatDate value='${model.endTime}' type="both" pattern='yyyy-MM-dd HH:mm:ss '/>"
                                       readonly
