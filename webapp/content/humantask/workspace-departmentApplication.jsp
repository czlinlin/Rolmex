...
<%pageContext.setAttribute("currentChildMenu", "部门申请");%>
<!doctype html>
<html lang="en">
...
<head>
    ...
    <script type="text/javascript">
        ...
        function fnSearch() {
            document.getElementById("charege-infoForm").action = "workspace-departmentApplication.do";
        }
        function fnGoAction() {
            ...
            document.getElementById("charege-infoForm").action = "departmentApplication-export.do";
        }
    ...
    <section id="m-main" class="col-md-10" style="padding-top:65px;">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form id="charege-infoForm" name="charege-infoForm" method="post" action="workspace-departmentApplication.do"
                      class="form-inline">
                    <div class="row">
                        <div class="col-md-4">
                            <label >受理单号:</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" style="width:150px;" maxlength="10" id="charege-info_ucode"
                                   name="filter_LIKES_ucode" value="${param.filter_LIKES_ucode}" class="form-control fntrim" onkeyup="value=value.replace(/[^\d]/g,'')">
                        </div>
                        <div class="col-md-4">
