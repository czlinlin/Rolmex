...
<head>
    ...
    <script type="text/javascript">
        ...
        function fnSearch() {
            document.getElementById("charege-infoForm").action = "workspace-speicalPeopleApproval.do";
        }
        function fnGoAction() {
            ...
            document.getElementById("charege-infoForm").action = "speicalPeopleApproval-export.do";
        }
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="charege-infoForm" name="charege-infoForm" method="post"
                      action="workspace-speicalPeopleApproval.do"
                      class="form-inline">
                    <div class="row">
                        <div class="col-md-4">
                            <label >受理单号:</label>
