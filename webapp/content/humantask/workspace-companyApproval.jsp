...
<%pageContext.setAttribute("currentChildMenu", "公司审批");%>
<!doctype html>
<html lang="en">
...
<head>
    ...
    <script type="text/javascript">
        ...
        function fnSearch() {
            document.getElementById("charege-infoForm").action = "workspace-companyApproval.do";
        }
        function fnGoAction() {
            ...
            document.getElementById("charege-infoForm").action = "companyApproval-export.do";
        }
    ...
    <section id="m-main" class="col-md-10" style="padding-top:65px;">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form id="charege-infoForm" name="charege-infoForm" method="post" action="workspace-companyApproval.do"
                      class="form-inline">
                    <div class="row">
                        <div class="col-md-4">
                            <label >受理单号:</label>
