...
<%pageContext.setAttribute("currentChildMenu", "部门审批");%>
<!doctype html>
<html lang="en">
...
<head>
    ...
    <script type="text/javascript">
        ...
        function fnSearch() {
            document.getElementById("charege-infoForm").action = "workspace-departmentApproval.do";
        }
        function fnGoAction() {
            ...
            document.getElementById("charege-infoForm").action = "departmentApproval-export.do";
        }
    ...
    <section id="m-main" class="col-md-10" style="padding-top:65px;">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form id="charege-infoForm" name="charege-infoForm" method="post" action="workspace-departmentApproval.do"
                      class="form-inline">
                    <div class="row">
                        <div class="col-md-4">
                            <label >受理单号:</label>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <label>申请人:</label>
                            <input type="text" style="width:200px;" maxlength="15" id="charege-info_DISPLAY_NAME"
                                   name="filter_LIKES_DISPLAY_NAME" value="${param.filter_LIKES_DISPLAY_NAME}"
                                   class="form-control" onchange="fntrim(this)">
                        </div>
                        <div class="col-md-4">
                            <label >经销商编号:</label>
