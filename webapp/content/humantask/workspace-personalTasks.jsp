...
<head>
    ...
    <script type="text/javascript">
		...
		点击抄送弹出抄送表单页面
		*/
        function copy(processInstanceId,title){
        	
     			popWin.scrolling="auto";
     			popWin.showWin("1000"
     	    			,"600"
     	    			,""
     	    			,"${tenantPrefix}/workOperationCustom/custom-copy-edit.do?processInstanceId="+processInstanceId+"&title="+title+"");
    ...
    <section id="m-main" class="col-md-10" style="padding-top: 65px;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form id="charege-infoForm" name="charege-infoForm" method="post" action="workspace-personalTasks.do"
                      class="form-inline">
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" style="width:150px;" maxlength="10" id="charege-info_ucode"
                                   name="filter_LIKES_ucode" value="${param.filter_LIKES_ucode}" class="form-control" onchange="fntrim(this)" onkeyup="value=value.replace(/[^\d]/g,'')">
                        </div>
                    </div>
                    <br>
                    <div class="row">
                    ...
                    <table id="pimRemindGrid" class="table table-hover mytable" style="min-width:1400px;">
                        ...
                        <c:forEach items="${page.result}" var="item">
                            <tr <c:if test="${item.businessDetailId != '8001' or item.businessDetailId == '8001'}"></c:if> <c:if test="${item.businessDetailId == '8001' and item.compare==false}">style="color:red;"</c:if>>
                             <td>
                               <a href="${tenantPrefix}/operation/task-operation-viewTaskForm.do?humanTaskId=<tags:encrypParameter parameters='${item.id}'/>&processInstanceId=<tags:encrypParameter parameters='${item.processInstanceId}'/>&action=&catalog=${item.catalog}">处理</a> 
                              ...
                              <%-- <a href='javascript:' onclick='copy("${item.processInstanceId}","${item.theme}")'>抄送</a> --%>
