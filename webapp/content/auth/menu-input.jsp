...
<%pageContext.setAttribute("currentChildMenu", "菜单管理");%>
<!doctype html>
<html>
...
<form id="menuForm" method="post" action="menu-save.do" class="form-horizontal">
  ...
  <div class="form-group">
	...
	<div class="col-sm-5">
	  <input id="menu_priority" type="text" name="priority" value="${model.priority}" size="40" class="form-control required number" minlength="1" maxlength="50">
    </div>
  </div>
