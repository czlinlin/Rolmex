...
<head>
    ...
    <title><spring:message code="dev.role-viewList.list.title" text="麦联"/></title>
...
<div class="row-fluid">
    ...
    <section id="m-main" class="col-md-10" style="padding-top:65px;">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <div class="pull-right ctrl">
                    <a class="btn btn-default btn-xs"><i id="role-viewListSearchIcon"
                                                         class="glyphicon glyphicon-chevron-up"></i></a>
                </div>
            </div>
            <div class="panel-body">
                <form name="role-viewListForm" method="post" action="role-viewList.do" class="form-inline">
                    <label for="role-viewList_name"><spring:message code='role-viewList.role-viewList.list.search.name'
                                                                    text='名称'/>:</label>
                    <input type="text" id="role-viewList_name" name="filter_LIKES_name"
        ...
        <form id="role-viewListGridForm" name="role-viewListGridForm" method='post' action="role-viewRemove.do"
              class="m-form-blank">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="glyphicon glyphicon-list"></i>
                    ...
                    <c:forEach items="${page.result}" var="item">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="role-viewInput.do?id=${item.id}" class="a-update"><spring:message
                                        code="core.list.edit" text="编辑"/></a>&nbsp;
                                <a href="role-perm-input.do?id=${item.id}" class="a-config"><spring:message
                                        code="auth.roleDef.list.perm" text="设置权限"/></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
