...
<html lang="en">
  ...
  <head>
    ...
    <title><spring:message code="dev.user-connector.list.title" text="麦联"/></title>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		  ...
		  <form name="user-connectorForm" method="post" action="user-connector-list.do" class="form-inline">
		    ...
		    <input type="text" id="user-connector_name" name="filter_LIKES_AI.username" value="${param.filter_LIKES_AI.username}" class="form-control">
