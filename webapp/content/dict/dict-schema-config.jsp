  ...
  <div class="panel-body">
      ...
      <div style="margin-bottom: 20px;">
	    <div class="pull-left btn-group" role="group">
		  <button class="btn btn-default a-insert" onclick="location.href='dict-schema-input.do?typeId=${typeId}'">新建</button>
...
<form id="dict-typeGridForm" name="dict-typeGridForm" method='post' action="dict-schema-remove.do?typeId=${typeId}" class="m-form-blank">
      <div class="panel panel-default">
        <div class="panel-heading">
		  <i class="glyphicon glyphicon-list"></i>
