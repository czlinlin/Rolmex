...
<head>
    ...
    .mytable tr td .workTask_title{width:150px;display:block;overflow: hidden;}
    .table{width:100%;}
    ...
    <section id="m-main" class="col-md-10" style="padding-top:65px;">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form name="workTaskInfoForm" method="post" action="work-task-info-cclist.do" class="form-inline">
                    ...
                    &nbsp;&nbsp;
                    <label for="pickerStartTime"> 计划完成时间:</label>
        ...
        <form id="workTaskInfoGridForm" name="workTaskInfoGridForm" method='post' action="work-task-info-cclist.do"
              class="m-form-blank">
            <div class="panel panel-default">
                <div class="panel-heading">
                    列表
				...
				<a href="${tenantPrefix}/worktask/worktask-CC-input-new.do?id=${item.id}">[抄送]</a>
                            ...
                            <td>
                                <a class="workTask_title rwop" title="${item.title}" href='work-task-info-detail.do?id=${item.id}'>
                                        ${item.title}
                                </a>
                            </td>
                            <td>
