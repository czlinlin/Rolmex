            ...
            <div class="panel-body">
                ...
                <form id="workTaskInfoForm" method="post" class="form-horizontal" action="work-task-info-save.do"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input id="WorkTaskInfo_title" type="text" name="title"
                                   value="${model.title}" size="40" onKeyUp="keypress1()" onblur="keypress1()"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <textarea id="workTaskInfo_content" name="content"
                                      ...
                                      rows="5" onKeyUp="keypress2()"
                                      onblur="keypress2()">${model.content}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <%--
                                      <input class="form-control" type="text" value="历史附件：${filename}" readonly>--%>
