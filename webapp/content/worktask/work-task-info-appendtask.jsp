...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            fnTaskTime(sectionJson)
        })
    </script>
    <script>
        var fnTaskTime = function (eleTimes) {
            $(eleTimes).each(function (i, ele) {
                ...
                $(ele.begin + " input").attr("onclick", "WdatePicker({minDate:'${start}',maxDate:'#F{$dp.$D(\\'" + end + "\\',{H:-1})||\\'${plan}\\'}',dateFmt:'yyyy-MM-dd HH:00:00'})");
                $(ele.end + " input").attr("onclick", "WdatePicker({maxDate:'${plan}',minDate:'#F{$dp.$D(\\'" + begin + "\\',{H:+1})||\\'${start}\\'}',dateFmt:'yyyy-MM-dd HH:00:00'})");
                //开始时间
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form id="workTaskInfoForm" method="post" class="form-horizontal" action="work-task-info-save.do"
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2" for="workTaskInfo_starttime">
                            <span style="color:red;"> * </span> 计划开始时间</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            ...
                            <c:if test="${model.status!=1 and model.status!=0}">
                                &nbsp;
