    ...
    <script type="text/javascript">
        $(function () {
            ...
            createUserPicker({
                ...
                multiple: true,
                showExpression: true,
                searchUrl: '${tenantPrefix}/rs/user/searchNoMe',
                treeUrl: '${tenantPrefix}/party/asyncTree.do?partyStructTypeId=1&notViewPost=true&notAuth=false',
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form id="workTaskInfoForm" method="post" class="form-horizontal" action="work-task-info-save.do"
                    ...
                    <c:if test="${proStatus=='0' or proStatus=='1'}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input id="WorkProjectInfo_projectcode" type="hidden" name="projectcode"
                                           value="${proId}" size="40" class="form-control">
                                    <input id="WorkProjectInfo_projectname" type="text" name="projectname"
                                           value="  ${proTitle}" size="40" class="form-control" readonly>

                                </div>
                            </div>
                        </c:if></c:if>
                    <c:if test="${FStatus=='0' or FStatus=='1'}">
                        <c:if test="${uppercode!= null}">
                            <div class="form-group">
                                <label class="control-label col-md-2" for="WorkTaskInfo_uppercode">上级任务</label>
                                <div class="col-md-8">
                                    <input id="uppercode" type="hidden" name="uppercode" value="${model.uppercode}">
                                    <input id="WorkTaskInfo_uppercode" type="text" name="uppercodename"
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2">抄送人</label>
                        <div class="col-md-8">
                            <div class="input-group userPicker">
                            ...
                            <font color='gray'>抄送人与负责人重复，将自动剔除</font>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div id="pickerStartTime" class="input-group date">
                                <input id="workTaskInfo_starttime" type="text" name="starttime"
                                       value="<fmt:formatDate value='${model.starttime}' pattern='yyyy-MM-dd HH:mm'/>"
                        ...
                        <div class="col-sm-8">
                            <div id="pickerEndTime" class="input-group date">
                                <input id="workTaskInfo_plantime" type="text" name="plantime"
                                       value="<fmt:formatDate value='${model.plantime}' pattern='yyyy-MM-dd HH:mm'/>"
                                       readonly
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input id="workTaskInfo_workload" type="text" name="workload"
                                   value="${model.workload}" size="40" class="form-control required number">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2" name="fileName">新添附件</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            ...
                            <button type="button" class="btn btn-default"
                                    onclick="window.location.href='work-task-info-sent-list.do'">返回
                            </button>
                        </div>
                    </div>
                </form>
