...
<head>
    ...
    <script type="text/javascript">
        function fnPoint() {
            bootbox.alert({
                message: '<p class="text-center"><i class="fa fa-spin fa-spinner"></i>进行中的项目负责人不可更改</p>',
                size: 'small',
            });
            return false
        }
            ...
            <div class="panel-body">
                ...
                <form id="workProjectInfoForm" method="post" class="form-horizontal" action="work-project-info-save.do"
                    ...
                    <c:if test="${not empty model}">
                        <input id="workProjectInfo_id" type="hidden" name="id" value="${model.id}">
                    </c:if>
                    <input id="datastatus" type="hidden" name="datastatus">
                    <div class="form-group">
                        <label class="control-label col-md-2" for="workProjectInfo_title"><span style="color: red">
                            * </span> 项目名称</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2" for="workProjectInfo_content"><span style="color: red">
                            * </span> 项目描述</label>
                        <div class="col-md-8">
                            <textarea id="workProjectInfo_content" name="content"
                                      class="form-control required" style="width:100%" onkeyup="keypress2()" onblur="keypress2()"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group userPicker">
                                ...
                                <div <c:if test="${model.status!=1}"> id='leaderDiv'</c:if> class="input-group-addon"
                                        <c:if test="${model.status==1}"> onclick="fnPoint()" </c:if>  ><i
