...
<%pageContext.setAttribute("currentChildMenu", "流程定义");%>
<!doctype html>
<html lang="en">

  <head>
    <%@include file="/common/meta.jsp"%>
    <title><spring:message code="dev.consoleProcessDefinitions.list.title" text="麦联"/></title>
...
--%>
      <div style="margin-bottom: 20px;">
	    <div class="pull-left btn-group" role="group">
		  ...
		  <form name="consoleProcessDefinitionsForm" method="post" action="console-listProcessDefinitions.do" class="form-inline">
		    <label for="consoleProcessDefinitions_name"><spring:message code='consoleProcessDefinitions.consoleProcessDefinitions.list.search.name' text='名称'/>:</label>
		    <input type="text" id="consoleProcessDefinitions_name" name="name" value="${name}" class="form-control">
			<button class="btn btn-default a-search" onclick="document.consoleProcessDefinitionsForm.submit()">查询</button>&nbsp;
		  </form>
		</div>
