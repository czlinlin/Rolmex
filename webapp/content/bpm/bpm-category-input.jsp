...
<%pageContext.setAttribute("currentChildMenu", "流程分类");%>
<!doctype html>
<html>
...
<form id="userRepoForm" method="post" action="bpm-category-save.do" class="form-horizontal">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <input id="bpm-category_priority" type="text" name="priority" value="${model.priority}" size="40" class="form-control required" minlength="1" maxlength="50" onkeyup="var reg = /^[1-9]\d*$/; if(!reg.test(this.value)) this.value = ''; "/>
    </div>
  </div>
  <div class="form-group">
    <div class="col-sm-5">
