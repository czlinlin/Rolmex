...
<%pageContext.setAttribute("currentChildMenu", "办结流程");%>
<!doctype html>
<html lang="en">
...
<head>
    ...
    <script type="text/javascript">
        ...
        function fnSearch() {
            document.getElementById("charege-infoForm").action = "workspace-listCompletedProcessInstances.do";
        }
        function fnGoAction() {
            ...
            document.getElementById("charege-infoForm").action = "listCompletedProcessInstances-export.do";
        }
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form id="charege-infoForm" name="charege-infoForm" method="post"
                      action="workspace-listCompletedProcessInstances.do"
                      class="form-inline">
                    <div class="row">
                        <div class="col-md-4">
                            <label>受理单号:</label>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <select id="workTask_Status" class="form-control" name="filter_EQS_pro_status" title="">
                                ...
                                <c:forEach items="${statuslist}" var="item">
                                    <c:if test="${item.value=='2' or item.value=='3' or item.value=='6'}">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" style="width:150px;" maxlength="10" id="charege-info_ucode"
                                   name="filter_LIKES_ucode" value="${param.filter_LIKES_ucode}" class="form-control"
                                   onchange="fntrim(this)" onchange="fntrim(this)"
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <label for="workTask_Status">业务类型:</label>
                        ...
                        <div class="col-md-8">
                            <label for="workTask_Status">业务明细:</label>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div id="pickerStartTime" class="input-group  date">
                                <input style="width:160px;" type="text" name="filter_GED_start_time"
                                       value="${param.filter_GED_start_time}" class="form-control required valid">
					...
					<i class="glyphicon glyphicon-calendar"></i>
                            ...
                            <div id="pickerEndTime" class="input-group  date">
                                <input style="width:160px;" type="text" name="filter_LED_start_time"
                                       value="${param.filter_LED_start_time}" class="form-control required valid">
                                <span class="input-group-addon">
					<i class="glyphicon glyphicon-calendar"></i>
				</span>
                            </div>
                        ...
                        <div class="col-md-4">
                            <label>申请人:</label>
                            <input type="text" style="width:200px;" maxlength="30" name="filter_LIKES_full_name" 
                                   value="${param.filter_LIKES_full_name}"
                                   class="form-control" >
                        </div>
                        <div class="col-md-2">
                ...
                <div style="overflow-x:scroll">
                    <table id="pimRemindGrid" class="table table-hover mytable" style="min-width:1400px;">
                        ...
                        <c:forEach items="${page.result}" var="item">
                            <tr  <c:if
                                    test="${item.status == '未审核'|| item.status == '驳回发起人'}"> style="color:blue" </c:if>
                                ...
                                <td>${item.status}</td>
                                    <%-- <tags:processName processDefinitionId="${item.processDefinitionId}"/> --%>
                                <td>${item.ucode}</td>
