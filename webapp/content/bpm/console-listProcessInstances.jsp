...
<%pageContext.setAttribute("currentChildMenu", "流程实例");%>
<!doctype html>
<html lang="en">

  <head>
    <%@include file="/common/meta.jsp"%>
    <title><spring:message code="dev.consoleProcessInstances.list.title" text="麦联"/></title>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <a href="${tenantPrefix}/bpm/workspace-viewHistory.do?processInstanceId=${item.id}">历史</a>
