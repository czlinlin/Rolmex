...
<html lang="en">
  ...
  <body>
	...
	<div class="panel-group col-md-1"></div>
	<!-- start of main -->
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
		    列表
		  <div class="pull-right"><%-- /party/form_detail.do --%>
		  	<c:if test="${url != ''}">
		  		<a href="workspace-viewHistoryFrom.do?processInstanceId=${historicProcessInstance.id}&url=${url}" target="_blank"><font style="color:#FFFFFF">表单详情</font></a>
		  	</c:if>
		  </div>
		</div>
	    ...
	    <table id="demoGrid" class="table table-hover">
	      ...
	      <tbody>
	       <tr>
	        ...
	        <tr style="border-top:0px hidden;"><td>批示内容</td><td colspan="4" style="width:1300px"><pre>${item.comment}</pre></td></tr>
	        </c:if>
