     ...
     <script>
        ...
        var fnSubmit=function(form){
        	...
        	if(userId==undefined||userId==null||userId.length<1){
        		var employeeNo=$("#employeeNo_Newnum").val();
        		//$("#userBaseForm").attr("action","person-info-save.do");
        		$.ajax({
                    url: "${tenantPrefix}/rs/user/person-info-checkEmployeeNo",
                    type: "POST",
                    ...
                    success: function (data) {
                    	if(data!=undefined&&data!=null){
            				if(data.code==200){
            					...
            					alert(data.message);
            					$("#employeeNo_Newnum").removeAttr("readonly");
            					$("#employeeNo_Newnum").val(data.data);
            					return false;
            				}
            			}
                    },
        ...
        var audit="${isAudit}";
        var fnCheckApplyCode=function(form){
        	if(audit=="1"){
        		if($("input[name='nextID']").val()==""){
        			alert("请选择审批人");
        			return false;
        		}
...
<div class="row-fluid">
		...
		<section id="m-main" class="col-md-12" style="padding-top: 3px;">
			...
			<ul class="breadcrumb">
				<li><a href="person-info-list-i.do">花名册 </a></li>
				<li class="active"></li>
			</ul>
		...
		<div class="panel-heading">
			...
			<div class="panel-body">
					...
					<form id="userBaseForm" method="post" enctype="multipart/form-data"
						action="${model.id == null ? 'person-info-save.do' : 'person-info-update.do'}"
						...
						<c:if test="${model.id == null}">
							...
							<div class="form-group">
								<label class="control-label col-md-1" for="orgInputUser_status">上级机构</label>
								<div class="col-sm-5" style="padding-top:7px;">${partyEntity.name}</div>
...
<!-- 								录入新用户，生成新的工号 -->
								<c:if test="${model.id == null}">
									<input type="text" value="${workNumberPrefix	}" id="employeeNo_depart"  placeholder="请输入工号前缀(必填)"
										name="employeeNoDepart"  class="form-control required" style="width:200px;display:inline;">
									<input type="text"  id="employeeNo_Newnum" class="form-control required" style="width:100px;display:inline;"
										name="employeeNoNum"  value="${employeeNoNum}">
								</c:if>
							</div>
						</div>
							...
							<label class="control-label col-md-1" for="org_orgname"><font
								color="red">*</font>
	                        		...
	                        		<c:if test="${isOpenOtherName == '1'}">
										...
										<div class="col-sm-5">
											<input type="text" class="form-control required" minlength="2"   placeholder="请输入姓名(必填)" 
												maxlength="50" id="userBase_realName" name="realName"
					...
					<c:if test="${isOpenOtherName == '1'&& model.id != null}">
							
						<div class="form-group">
						
						<label class="control-label col-md-1" for="userPickerForBieming">
							<spring:message code="org.org.input.orgname" text="别名" /></label>
									<div class="col-sm-5">
										<input type="text" class="form-control " minlength="2"    placeholder=""
											maxlength="50" id="userBase_fullName" name="fullName"
					...
					<div class="form-group">
							...
							<div class="col-sm-5">
								<input id="telephone" type="text" name="telephone"  placeholder="请输入联系电话(必填)"
					...
					<div class="form-group">
							...
							<label class="control-label col-md-1" for="userBase_fax">紧急联系人及电话</label>
							<div class="col-sm-5">
					...
					<div class="form-group">
							...
							<div class="col-sm-5">
<!-- 								<input id="nation" type="text" name="nation"  placeholder="请输入民族" -->
<%-- 									value="${model.nation}" size="40" class="form-control required" --%>
<!-- 									 minlength="1" -->
<!-- 									maxlength="40"> -->
							...
							<div class="col-sm-5">
<!-- 								<input id="education" type="text" name="education"  placeholder="请输入学历" -->
<%-- 									value="${model.education}" size="40" class="form-control required" --%>
<!-- 									 minlength="2" -->
<!-- 									maxlength="50"> -->
				...
				<div class="form-group">
							...
							<label class="control-label col-md-1" for="academic_degree"><font
								...
								<div class="col-sm-5">
<!-- 									<input id="academic_degree" type="text" name="academicDegree"  placeholder="请输入学位" -->
<%-- 										value="${model.academicDegree}" size="40" class="form-control required" --%>
<!-- 										 minlength="2" -->
<!-- 										maxlength="100"> -->
					...
					<div class="form-group">
							...
							<div class="col-sm-5">
<!-- 								<input id="labor_type" type="text" name="laborType"  placeholder="请输入用工类型" -->
<%-- 									value="${model.laborType}" size="40" class="form-control required" --%>
<!-- 									 minlength="2" -->
<!-- 									maxlength="50"> -->
					...
					<div class="form-group">
							...
							<div class="col-sm-5">
<!-- 								<input id="entry_mode" type="text" name="entryMode"  placeholder="请输入进入方式" -->
<%-- 									value="${model.entryMode}" size="40" class="form-control required" --%>
<!-- 									 minlength="2" -->
<!-- 									maxlength="50"> -->
				...
				<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input id="userBase_priority" type="text" name="priority" value="0"
									value="${model.priority}" size="40"  placeholder="请输入排序号"
				   ...
				   onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'0')}else{this.value=this.value.replace(/\D/g,'')}"--%>
						...
						<div class="form-group">
							...
							<div class="col-sm-5" id="quitFlagId">
								<input name="oldQuitFlag" type="hidden" value="${model.quitFlag}" />
								<label for="fertility_condition1" class="radio inline col-md-3"> <input 
					...
					<div class="form-group">
							<div class="col-md-offset-1 col-md-5">
								...
								<button id="submitButton" type="submit"
									...
									<spring:message code='core.input.save' text='提交数据' />
								</button>
								<button type="button" onclick="history.back();"
									class="btn btn-link a-cancel">
