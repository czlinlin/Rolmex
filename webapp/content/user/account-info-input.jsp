...
<form id="userBaseForm" method="post" action="account-info-save.do" class="form-horizontal">
  ...
  <div class="form-group">
    <label class="control-label col-md-1" for="userBase_username"><spring:message code="user.user.input.username" text="选择员工"/></label>
	<div class="col-sm-5">
	  <div class="input-group userPicker">
        <input id="_task_name_key" type="hidden" name="code" value="${model.code}">
