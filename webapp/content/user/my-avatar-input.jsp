...
<form id="userBaseForm" method="post" action="my-avatar-crop.do" class="form-horizontal">
  ...
  <div class="control-group">
	...
	<div class="controls">
	  <div id="avatarImage">
	    <c:if test="${not empty accountInfo.accountAvatars}">
		  <img src="my-avatar-view.do" style="width:512px;">
		</c:if>
	  </div>
	  <div id="avatarButton" class="btn btn-success fileinput-button">
		...
		<input type="file" name="avatar" class="fileupload"
		  ...
		  data-form-data='{"id":"${accountInfo.id}","imgId":"avatarImage","btnId":"avatarButton","viewUrl":"my-avatar-view.do"}'>
	  </div>
