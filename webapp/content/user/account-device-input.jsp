...
<%pageContext.setAttribute("currentMenuName", "用户管理");%>
<%pageContext.setAttribute("currentChildMenu", "设备管理");%>
<!doctype html>
<html lang="en">

  <head>
    <%@include file="/common/meta.jsp"%>
    <title><spring:message code="account-device.account-device.input.title" text="麦联"/></title>
