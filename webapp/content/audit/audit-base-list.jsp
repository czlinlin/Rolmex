...
<%pageContext.setAttribute("currentChildMenu", "审计日志");%>
<!doctype html>
<html lang="en">

  <head>
    <%@include file="/common/meta.jsp"%>
    <title><spring:message code="dev.audit-base.list.title" text="麦联"/></title>
...
var config = {
    ...
    asc: ${page.asc},
    params: {
        'filter_LIKES_action': '${param.filter_LIKES_action}'
    },
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
		  ...
		  <form name="audit-baseForm" method="post" action="audit-base-list.do" class="form-inline">
		    <label for="audit-base_name"><spring:message code='audit-base.audit-base.list.search.name' text='操作'/>:</label>
		    <input type="text" id="audit-base_action" name="filter_LIKES_action" value="${param.filter_LIKES_action}" class="form-control">
