    ...
    <div id="collapse-body-account-device" class="panel-collapse collapse ${currentMenu == 'account-device' ? 'in' : ''}" role="tabpanel" aria-labelledby="collapse-header-account-device">
      <div class="panel-body">
        <ul class="nav nav-pills nav-stacked">
		  <li class = "${currentChildMenu == '设备管理' ? 'active' : ''}"><a href="${tenantPrefix}/user/account-device-list.do"><i class="glyphicon glyphicon-list ${currentChildMenu == '设备管理' ? 'active' : ''}"></i> 设备管理</a></li>
        </ul>
      </div>
    </div>
  </div>
