...
--%>
    ...
    <div id="collapse-body-party" class="panel-collapse collapse ${currentMenu == 'party' ? 'in' : ''}" role="tabpanel" aria-labelledby="collapse-header-party">
      <div class="panel-body">
        <ul class="nav nav-pills nav-stacked">
		  <li class = "${currentChildMenu == '组织机构图' ? 'active' : ''}"><a href="${tenantPrefix}/party/tree-list.do"><i class="glyphicon glyphicon-list class = "${currentChildMenu == '组织机构图' ? 'active' : ''}""></i> <spring:message code="layout.leftmenu.tree" text="组织机构图"/></a></li>
		  ...
		  <li class = "${currentChildMenu == '组织机构结构规则' ? 'active' : ''}"><a href="${tenantPrefix}/party/party-struct-rule-list.do"><i class="glyphicon glyphicon-list class = "${currentChildMenu == '组织机构结构规则' ? 'active' : ''}""></i> <spring:message code="layout.leftmenu.struct.rule" text="组织机构结构规则"/></a></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="panel panel-default">
    ...
    <div id="collapse-body-template" class="panel-collapse collapse ${currentMenu == 'template' ? 'in' : ''}" role="tabpanel" aria-labelledby="collapse-header-template">
      <div class="panel-body">
        <ul class="nav nav-pills nav-stacked">
		  <li class = "${currentChildMenu == '模板管理' ? 'active' : ''}"><a href="${tenantPrefix}/template/template-info-list.do"><i class="glyphicon glyphicon-list ${currentChildMenu == '模板管理' ? 'active' : ''}"></i> 模板管理</a></li>
		  <li class = "${currentChildMenu == '模板项管理' ? 'active' : ''}"><a href="${tenantPrefix}/template/template-field-list.do"><i class="glyphicon glyphicon-list ${currentChildMenu == '模板项管理' ? 'active' : ''}"></i> 模板项管理</a></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="panel panel-default">
    ...
    <div id="collapse-body-audit" class="panel-collapse collapse ${currentMenu == 'audit' ? 'in' : ''}" role="tabpanel" aria-labelledby="collapse-header-audit">
      <div class="panel-body">
        <ul class="nav nav-pills nav-stacked">
		  <li class = "${currentChildMenu == '审计日志' ? 'active' : ''}"><a href="${tenantPrefix}/audit/audit-base-list.do"><i class="glyphicon glyphicon-list ${currentChildMenu == '审计日志' ? 'active' : ''}"></i> 审计日志</a></li>
        </ul>
      </div>
    </div>
  </div>
...
-->
  <div class="panel panel-default">
    ...
    <div id="collapse-body-dict" class="panel-collapse collapse ${currentMenu == 'dict' ? 'in' : ''}" role="tabpanel" aria-labelledby="collapse-header-dict">
      <div class="panel-body">
        <ul class="nav nav-pills nav-stacked">
		  <li class = "${currentChildMenu == '数据字典' ? 'active' : ''}"><a href="${tenantPrefix}/dict/dict-type-list.do"><i class="glyphicon glyphicon-list class = "${currentChildMenu == '数据字典' ? 'active' : ''}""></i> 数据字典</a></li>
        <li class = "${currentChildMenu == '业务类型' ? 'active' : ''}"><a href="${tenantPrefix}/dict/dict-business-type-list.do"><i class="glyphicon glyphicon-list class = "${currentChildMenu == '业务类型' ? 'active' : ''}""></i> 业务类型</a></li>
        <li class = "${currentChildMenu == '业务类型明细' ? 'active' : ''}"><a href="${tenantPrefix}/dict/dict-business-detail-list.do"><i class="glyphicon glyphicon-list class = "${currentChildMenu == '业务类型明细' ? 'active' : ''}""></i> 业务类型明细</a></li>
        </ul>
      </div>
    </div>
  </div>
...
-->
    ...
    <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="collapse-header-version" data-toggle="collapse" data-parent="#accordion" href="#collapse-body-version" aria-expanded="true" aria-controls="collapse-body-version">
            <h4 class="panel-title">
                <i class="glyphicon glyphicon-list"></i>
                版本管理
            </h4>
        </div>
        <div id="collapse-body-version" class="panel-collapse collapse ${currentMenu == 'version' ? 'in' : ''}" role="tabpanel" aria-labelledby="collapse-header-version">
            <div class="panel-body">
                <ul class="nav nav-pills nav-stacked">
                    <li class = "${currentChildMenu == '版本管理' ? 'active' : ''}"><a href="${tenantPrefix}/version/version-info-list.do"><i class="glyphicon glyphicon-list class = "${currentChildMenu == '版本管理' ? 'active' : ''}""></i> 版本管理</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="collapse-header-report-setting" data-toggle="collapse" data-parent="#accordion" href="#collapse-body-report-setting" aria-expanded="true" aria-controls="collapse-body-report-setting">
            <h4 class="panel-title">
                <i class="glyphicon glyphicon-list"></i>
               	 汇报条线
            </h4>
        </div>
        <div id="collapse-body-report-setting" class="panel-collapse collapse ${currentMenu == 'pim' ? 'in' : ''}" role="tabpanel" aria-labelledby="collapse-header-report-setting">
            <div class="panel-body">
                <ul class="nav nav-pills nav-stacked">
                    <li class = "${currentChildMenu == '汇报条线管理' ? 'active' : ''}">
                    	<a href="${tenantPrefix}/pim/work-report-cc-presetting-init.do">
                    		<i class="glyphicon glyphicon-list ${currentChildMenu == '汇报条线管理' ? 'active' : ''}"></i>
                    		汇报条线管理
                   		</a>
                	</li>
                </ul>
   ...
   <%-- <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="collapse-header-lock" data-toggle="collapse" data-parent="#accordion" href="#collapse-body-lock" aria-expanded="true" aria-controls="collapse-body-lock">
            <h4 class="panel-title">
                <i class="glyphicon glyphicon-list"></i>
                解锁管理
            </h4>
        </div>
        <div id="collapse-body-lock" class="panel-collapse collapse ${currentMenu == 'lock' ? 'in' : ''}" role="tabpanel" aria-labelledby="collapse-header-lock">
            <div class="panel-body">
                <ul class="nav nav-pills nav-stacked">
                    <li class = "${currentChildMenu == '解锁管理' ? 'active' : ''}"><a href="${tenantPrefix}/user/account-lock-info-list.do"><i class="glyphicon glyphicon-list class = "${currentChildMenu == '解锁管理' ? 'active' : ''}""></i> 解锁管理</a></li>
                </ul>
            </div>
        </div>
    </div>--%>
