 ...
 <%-- <div class="panel panel-default">
  ...
  <div class="panel panel-default">
    ...
    <div id="collapse-body-task" class="panel-collapse collapse ${currentMenu == 'pim-task' ? 'in' : ''}" role="tabpanel" aria-labelledby="collapse-header-task">
     ...
     <div class="panel panel-default">
         ...
         <div id="collapse-body-cms" class="panel-collapse collapse ${currentMenu == 'cms' ? 'in' : ''}" role="tabpanel" aria-labelledby="collapse-header-msg">
             <div class="panel-body">
                 <ul class="nav nav-list">
                     <li><a href="${tenantPrefix}/cms/cms-article-tome.do"><i class="glyphicon glyphicon-list"></i> 公告</a></li>
  ...
  <div class="panel panel-default">
    ...
    <div id="collapse-body-msg" class="panel-collapse collapse ${currentMenu == 'msg' ? 'in' : ''}" role="tabpanel" aria-labelledby="collapse-header-msg">
      <div class="panel-body">
        <ul class="nav nav-list">
		  <li><a href="${tenantPrefix}/msg/msg-info-listReceived.do"><i class="glyphicon glyphicon-list"></i> 未读消息</a></li>
		  <li><a href="${tenantPrefix}/msg/msg-info-listRead.do"><i class="glyphicon glyphicon-list"></i> 已读消息</a></li>
		  <%-- <li><a href="${tenantPrefix}/msg/msg-info-listSent.do"><i class="glyphicon glyphicon-list"></i> 发件箱</a></li>
		  <li><a href="${tenantPrefix}/msg/msg-info-input.do"><i class="glyphicon glyphicon-list"></i> 新建消息</a></li> --%>
        </ul>
      </div>
