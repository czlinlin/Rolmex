    ...
    <div id="collapse-body-report" class="panel-collapse collapse ${currentMenu == 'report' ? 'in' : ''}" role="tabpanel" aria-labelledby="collapse-header-report">
      <div class="panel-body">
        <ul class="nav nav-pills nav-stacked">
		  <li class = "${currentChildMenu == '报表主题' ? 'active' : ''}"><a href="${tenantPrefix}/report/report-subject-list.do"><i class="glyphicon glyphicon-list ${currentChildMenu == '报表主题' ? 'active' : ''}"></i> 报表主题</a></li>
		  <li class = "${currentChildMenu == '报表查询' ? 'active' : ''}"><a href="${tenantPrefix}/report/report-query-list.do"><i class="glyphicon glyphicon-list ${currentChildMenu == '报表查询' ? 'active' : ''}"></i> 报表查询</a></li>
		  <li class = "${currentChildMenu == '报表维度' ? 'active' : ''}"><a href="${tenantPrefix}/report/report-dim-list.do"><i class="glyphicon glyphicon-list ${currentChildMenu == '报表维度' ? 'active' : ''}"></i> 报表维度</a></li>
		  <li class = "${currentChildMenu == '报表信息' ? 'active' : ''}"><a href="${tenantPrefix}/report/report-info-list.do"><i class="glyphicon glyphicon-list ${currentChildMenu == '报表信息' ? 'active' : ''}"></i> 报表信息</a></li>
        </ul>
      </div>
    </div>
  </div>
