    ...
    <div id="collapse-body-humantask" class="panel-collapse collapse ${currentMenu == 'humantask' ? 'in' : ''}" role="tabpanel" aria-labelledby="collapse-header-humantask">
      <div class="panel-body">
        <ul class="nav nav-pills nav-stacked">
		  <li class = "${currentChildMenu == '任务列表' ? 'active' : ''}"><a href="${tenantPrefix}/humantask/task-info-list.do"><i class="glyphicon glyphicon-list ${currentChildMenu == '任务列表' ? 'active' : ''}"></i> 任务列表</a></li>
        </ul>
      </div>
    </div>
  </div>
