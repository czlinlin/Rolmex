...
public class PartyUserNotification implements UserNotification {
    ...
    // insert
    private String insertPartyEntitySql = "INSERT INTO PARTY_ENTITY(ID,NAME,REF,TYPE_ID,DEL_FLAG) VALUES(?,?,?,?,'0')";
    private String selectPartyEntitySql = "SELECT ID FROM PARTY_ENTITY WHERE DEL_FLAG = '0' AND REF=? AND TYPE_ID=?";
    ...
    private String removePartyEntitySql = "UPDATE PARTY_ENTITY SET DEL_FLAG = '1' WHERE ID=?";
