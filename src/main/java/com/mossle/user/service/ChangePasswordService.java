...
public class ChangePasswordService {
    ...
    public ChangePasswordResult changePassword(String username,
        ...
        if (accountInfo.getDelFlag().equals(PersonInfoConstants.DELETE_FLAG_YES)) {
        	changePasswordResult.setCode("user.user.input.username.blank");
            changePasswordResult.setMessage("账号已被删除");
    ...
    public ChangePasswordResult changeOperationPassword(Long accountId,
            String oldPassword, String newPassword, String confirmPassword) {
        ChangePasswordResult changePasswordResult = new ChangePasswordResult();
        ...
        return this.changeOperationPassword(accountInfo, oldPassword, newPassword,
                confirmPassword);
    }
    ...
    public ChangePasswordResult changePassword(AccountInfo accountInfo,
        ...
        if (!isPasswordValid(oldPassword, accountCredential.getPassword())) {
            ...
            changePasswordResult.setMessage("原密码错误");
    ...
    public ChangePasswordResult changeOperationPassword(AccountInfo accountInfo,
            String oldPassword, String newPassword, String confirmPassword) {
        ChangePasswordResult changePasswordResult = new ChangePasswordResult();
        ...
        if (!isPasswordValid(oldPassword, accountCredential.getOperationPassword())) {
            changePasswordResult.setCode("user.user.input.passwordnotcorrect");
            changePasswordResult.setMessage("原密码错误");
