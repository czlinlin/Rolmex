...
public class DatabaseUserStatusUpdater implements UserStatusUpdater {
    ...
    private String selectSql = "select count(username) from AUTH_USER_STATUS where username=? and repo_code='0' and del_flag='0'";
    private String createSql = "insert into AUTH_USER_STATUS(username,status,repo_code,del_flag) values(?,?,'0','0')";
    ...
    private String removeSql = "update AUTH_USER_STATUS set del_flag='1' where username=? and repo_code='0'";
