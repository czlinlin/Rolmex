...
public class CaptchaFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        //移除此session，防止跳转超时的页面
        Object savedRequestObject = req.getSession().getAttribute("SPRING_SECURITY_SAVED_REQUEST");  
        ...
        //session.setAttribute("SPRING_SECURITY_SAVED_REQUEST", "DefaultSavedRequest[http://192.168.226.55:8080/Rolmex/humantask/workspace-personalTasks.do]");
        if (session == null) {
