...
public class RollbackCmd implements Command<Boolean> {
    ...
    public void processHistoryTask(
    		...
    		//shijingxin
    	    //String activityId = workspaceController.getActivityId(historicTaskInstanceEntity.getTaskDefinitionKey(), historicTaskInstanceEntity.getProcessDefinitionId());
        /*
        ...
        //task.setTaskDefinitionKey("sid-EEB8175F-52E0-4EDF-8F9B-0906702A49A2");//shijingxin
