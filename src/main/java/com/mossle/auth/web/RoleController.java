...
public class RoleController {
    ...
    @Log(desc = "系统配置", action = "save", operationDesc = "系统配置-权限管理-角色管理-保存角色")
    ...
    @Log(desc = "系统配置", action = "remove", operationDesc = "系统配置-权限管理-角色管理-删除")
    ...
    @Log(desc = "角色管理", action = "search", operationDesc = "系统配置-权限管理-角色管理-查看")
    ...
    @Log(desc = "角色管理", action = "input", operationDesc = "系统配置-权限管理-角色管理-添加")
    ...
    @Log(desc = "角色管理", action = "save", operationDesc = "系统配置-权限管理-角色管理-保存")
    ...
    @Log(desc = "角色管理", action = "remove", operationDesc = "系统配置-权限管理-角色管理-删除")
