...
public class UserConnectorController {
    ...
    public String list(@ModelAttribute Page page,
        ...
        if (parameters.isEmpty()) {
            ...
            String hql = "from UserStatus where delFlag='0' and tenantId=?";
            
            if (!PartyConstants.ADMIN_USER_ID.equals(accountId)) {
            	hql += " and (addUserId=? OR ref=?)";
            	page = userStatusManager.pagedQuery(hql, page.getPageNo(),
	                    page.getPageSize(), tenantId, currentUserHolder.getUserId(), currentUserHolder.getUserId());
            } else {
	            page = userStatusManager.pagedQuery(hql, page.getPageNo(),
            ...
            for (UserDTO userDto : userDtos) {
                ...
                String hql = "from UserStatus where delFlag = '0' and username=? and userRepoRef=?";
