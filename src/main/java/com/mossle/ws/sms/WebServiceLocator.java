...
public class WebServiceLocator extends org.apache.axis.client.Service implements com.mossle.ws.sms.WebService {
    ...
    private java.lang.String WebServiceSoap_address = "http://202.70.12.18/SmsService.asmx";
    ...
    public com.mossle.ws.sms.WebServiceSoap getWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	com.mossle.ws.sms.WebServiceSoapStub _stub = new com.mossle.ws.sms.WebServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.mossle.ws.sms.WebServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
            	com.mossle.ws.sms.WebServiceSoapStub _stub = new com.mossle.ws.sms.WebServiceSoapStub(new java.net.URL(WebServiceSoap_address), this);
                _stub.setPortName(getWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
