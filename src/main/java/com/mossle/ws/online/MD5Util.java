...
public class MD5Util {
    ...
    public static String requestTool(String requestMd5password) throws Exception {
    ...
    public static String getMd5(Map<String, Object> code, String key) {
        StringBuilder stringBuilder = new StringBuilder();
        String val = genSignData(code);
    ...
    //Oa动态拼接并生成签名
    public static String getMd5ForOa(Map<String, Object> code, String key) {
        StringBuilder stringBuilder = new StringBuilder();
        String val = genSignDataForOa(code);
        stringBuilder.append(val);
     ...
     * @return
     */
    public static String genSignDataForOa(Map<String, Object> map) {
        StringBuffer content = new StringBuffer();
        // 按照key做首字母升序排列
        List<String> keys = new ArrayList<>(map.keySet());
        Collections.sort(keys, String.CASE_INSENSITIVE_ORDER);
