...
public class ToOAServiceLocator extends org.apache.axis.client.Service implements com.mossle.ws.oaapply.ToOAService {
    ...
    private java.lang.String ToOAServiceSoap_address = "http://192.168.226.53:2500/ToOAService.asmx";
    ...
    public com.mossle.ws.oaapply.ToOAServiceSoap getToOAServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.mossle.ws.oaapply.ToOAServiceSoap getToOAServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	com.mossle.ws.oaapply.ToOAServiceSoapStub _stub = new com.mossle.ws.oaapply.ToOAServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.mossle.ws.oaapply.ToOAServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
            	com.mossle.ws.oaapply.ToOAServiceSoapStub _stub = new com.mossle.ws.oaapply.ToOAServiceSoapStub(new java.net.URL(ToOAServiceSoap_address), this);
                _stub.setPortName(getToOAServiceSoapWSDDServiceName());
                return _stub;
            }
        }
