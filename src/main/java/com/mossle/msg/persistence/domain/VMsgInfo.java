...
/**
 * Created by wanghan on 2018\1\22 0022.
 */


//消息视图
@Entity
@Table(name = "V_MSG_INFO")
public class VMsgInfo implements java.io.Serializable {
    ...
    public VMsgInfo(Long id) {
        this.id = id;
    }

    public VMsgInfo(Long id, String name, String content, Integer type,
