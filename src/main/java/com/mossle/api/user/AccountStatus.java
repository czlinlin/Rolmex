...
public class AccountStatus {
	...
	public static final String OTP_PASSWORD_TOO_SIMPLE = "otpPasswordTooSimple";
	...
	public static final String BAD_CREDENTIALS_Attempt2 = "badCredentialsAttempt2";
	public static final String BAD_CREDENTIALS_Attempt1 = "badCredentialsAttempt1";
	public static final String BAD_CREDENTIALS_LOCKED = "badCredentialsLocked";
	...
	public static final String Gesture_NOT_EXISTS = "gestureNotExists";// gesture_switch==null
	public static final String Gesture_NOT_Open = "gestureNotOpen";// gesture_switch!=open
