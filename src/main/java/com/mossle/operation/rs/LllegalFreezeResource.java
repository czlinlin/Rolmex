...
@Component
@Path("lllegalFreeze")
public class LllegalFreezeResource {
    private static Logger logger = LoggerFactory.getLogger(LllegalFreezeResource.class);
    ...
    public InputStream enclosures(@QueryParam("key") String key,
        ...
        StoreDTO storeDto = storeConnector.getStore("cms/jsp/lllegalFreeze",
                key, tenantId);
