...
@Component
@Path("Business")
public class BrachBusinessResource {
    private static Logger logger = LoggerFactory.getLogger(BrachBusinessResource.class);
    ...
    public InputStream enclosures(@QueryParam("key") String key,
        ...
        StoreDTO storeDto = storeConnector.getStore("cms/jsp/business",
                key, tenantId);
